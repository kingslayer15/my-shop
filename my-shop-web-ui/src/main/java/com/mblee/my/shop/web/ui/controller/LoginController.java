...
import com.mblee.my.shop.commons.utils.EmailSendUtils;
import com.mblee.my.shop.web.ui.api.UsersApi;
import com.mblee.my.shop.web.ui.constant.SystemConstants;
...
public class LoginController {
    ...
    public String login(TbUser tbUser, Model model, HttpServletRequest request) throws Exception {
        ...
        // 登录成功
            ...
            emailSendUtils.send("用户登录", String.format("用户 【%s】 登录 MyShop", user.getUsername()), "mblee@yeah.net");
            // 将会员信息放入 Session
